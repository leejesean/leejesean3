...
class Monster:
    ...
    def draw(self):
        ...
        self.image2.clip_draw(0, 0, 30, 5,self.monsterx, self.monstery-50)
        self.image3.clip_draw(0, 0, self.hp, 5,self.monsterx, self.monstery-50)
    def get_bb(self):
