...
class Monster:
    ...
    def update(self):
        ...
        if self.turn == 1 and self.Damage==FALSE and self.Daed==FALSE:#오른쪽걸어갈때
            self.movey=8*380
            self.frame = (self.frame + 1 ) % 4
        elif self.turn == -1 and self.Damage==FALSE and self.Daed==FALSE:#왼쪽걸어갈때
            self.movey=9*380
            self.frame = (self.frame + 1 ) % 4
        ...
        if self.monsterx >750:
            self.turn *=-1
        elif self.monsterx < 50:
            self.turn *=-1
